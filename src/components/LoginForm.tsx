          ...
          if (snapshot.exists()) {
            ...
            if (userFound) {
              if (!isActive) {
                ...
                localStorage.clear();
                showToast(
                  "Your account is currently disabled. Please contact the super admin."
                );
                return;
              }
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      localStorage.setItem(
        "agentLimit",
        userData.agentLimit?.toString() || "0"
      );
      ...
      if (userRole === "agent") {
        ...
        await update(
          ref(database, `users/${userData.adminId}/agents/${user.uid}`),
          {
            lastLogin: now,
          }
        );
  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        animate={{ opacity: 1 }}
        exit={{ opacity: 0 }}
        className={`flex items-center justify-center min-h-screen p-4 ${theme === "dark" ? "bg-gray-900" : "bg-gray-50"}`}
      >
        {/* Theme toggle button */}
        <Button
          variant="ghost"
        ...
        <motion.div
          ...
          className={`flex flex-col lg:flex-row w-full max-w-5xl ${theme === "dark" ? "bg-gray-800 border-gray-700" : "bg-white border-gray-200"} rounded-lg shadow-2xl overflow-hidden border`}
        >
            ...
            >
              ...
              >
                <TabsList className={`grid w-full grid-cols-2 ${theme === "dark" ? "bg-gray-700" : "bg-gray-100"}`}>
                  <TabsTrigger 
                    value="admin" 
                    className={`${theme === "dark" ? "text-white data-[state=active]:bg-gray-600" : "text-gray-800 data-[state=active]:bg-white"}`}
                  >
                    Admin
                  </TabsTrigger>
                  <TabsTrigger 
              ...
              <TabsContent value="admin">
                ...
                >
                  ...
                  <div className="space-y-4">
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        className={`${theme === "dark" ? "bg-gray-700 text-white border-gray-600 focus:ring-blue-500" : "bg-white text-gray-900 border-gray-300 focus:ring-blue-500"} focus:ring-2 focus:border-transparent`}
                        value={email}
                  ...
                  <Button
                    type="submit"
                    className="w-full bg-blue-600 hover:bg-blue-700 text-white transition-all duration-300 flex items-center justify-center gap-2"
                    disabled={isLoading}
                  >
                    {isLoading ? (
                      <>
                  ...
                  {/* <div className="relative flex items-center py-5">
                    ...
                    <span className={`flex-shrink mx-4 text-sm ${theme === "dark" ? "text-gray-400" : "text-gray-500"}`}>
                      Sign in using
                    </span>
                    <div className={`flex-grow border-t ${theme === "dark" ? "border-gray-700" : "border-gray-300"}`}></div>
                  </div>
                  ...
                  <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 lg:grid-cols-6 gap-2">
                    <Button
                      variant="ghost"
                      className={`w-full aspect-square p-2 ${theme === "dark" ? "bg-gray-700 border-gray-600 hover:bg-gray-600" : "bg-gray-100 border-gray-200 hover:bg-gray-200"} border shadow-sm flex items-center justify-center rounded-md`}
                      onClick={() =>
                    ...
                    <Button
                      ...
                      className={`w-full aspect-square p-2 ${theme === "dark" ? "bg-gray-700 border-gray-600 hover:bg-gray-600" : "bg-gray-100 border-gray-200 hover:bg-gray-200"} border shadow-sm flex items-center justify-center rounded-md`}
                      onClick={() =>
                        showToast("YouTube login coming soon!", "info")
                      }
                    >
                    ...
                    <Button
                      ...
                      className={`w-full aspect-square p-2 ${theme === "dark" ? "bg-gray-700 border-gray-600 hover:bg-gray-600" : "bg-gray-100 border-gray-200 hover:bg-gray-200"} border shadow-sm flex items-center justify-center rounded-md`}
                      onClick={() =>
                        showToast("Twitter login coming soon!", "info")
                      }
                    >
          ...
          <div className={`hidden lg:flex flex-col flex-1 items-center justify-center p-8 lg:w-1/2 ${theme === "dark" ? "bg-gray-800" : "bg-gray-50"}`}>
            <motion.div
            ...
            >
              ...
              <div className="mb-6">
                <div className="h-10 mx-auto lg:mx-0">
                  <img
                    ...
                    alt="PTS CRM Logo"
                    className={`h-full w-auto ${theme === "dark" ? "filter brightness-0 invert" : ""}`}
                  />
                </div>
              </div>
              ...
              <motion.p
                ...
                className={`mb-8 max-w-prose ${theme === "dark" ? "text-gray-300" : "text-gray-600"}`}
              >
                Capture leads effortlessly, track interactions, schedule
                meetings, and automate follow-ups—all in one secure system.
                Never miss an opportunity with real-time updates and AI-powered
                insights.
              </motion.p>
            </motion.div>
          </div>
